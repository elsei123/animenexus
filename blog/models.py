...
class Post(models.Model):
    ...
    cover_image = models.ImageField(
        upload_to="covers/", blank=True, null=True, help_text="Optional cover image for the post."
    )
    ...
    featured = models.BooleanField(default=False, help_text="Mark post as featured on the home page.")
...
class Comment(models.Model):
    ...
    approved = models.BooleanField(default=False, help_text="Designates whether the comment is approved.")
    created_at = models.DateTimeField(default=timezone.now, help_text="Timestamp when the comment was created.")
